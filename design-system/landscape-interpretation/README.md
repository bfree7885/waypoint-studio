...
1. **No fake evaluation** — do not ship a JS scorer that invents land history without observations or documented layers.
2. **Observation ≠ interpretation** — keep them separate in every API and UI later.
