...
(function (global) {
  ...
  function renderLinkageNote(linkage) {
    ...
    var explorer =
      ...
      "Relationship Explorer soft-link deferred until the route exists on main.";
    return (
      '<aside class="gsc-linkage" aria-label="Relationship linkage">' +
      "<p><strong>Relationship model.</strong> Statements use stable entity ids (<code>gsn_*</code>), evidence ids, and cause chains aligned with Articles confidence and horizon vocabulary.</p>" +
      "<p>" +
      esc(explorer) +
      "</p>" +
      '<p class="gsc-linkage__links">' +
      '<a href="../relationship-graph/">Relationship Graph (placeholder)</a>' +
