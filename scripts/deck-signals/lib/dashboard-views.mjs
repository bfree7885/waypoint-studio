/**
 * Build Deck-internal situational-awareness dashboard JSON from live records + health.
...
export function buildDashboardViews(live, health) {
  ...
  return {
    meta: {
      ...
      engine: live?.meta?.engine || "deck-signals-live-engine",
      principles: [
    ...
    sourceHealth,
    absences: {
      threatLevel: "NO CURRENT DATA — this ingest does not invent a composite threat level without an authoritative source.",
