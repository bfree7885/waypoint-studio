...
export function buildDefenseItem(rec, ctx = {}) {
  ...
  return {
    ...
    disclaimer:
      "This ingest has not inspected your devices, networks, or accounts. These are general defensive recommendations derived from public threat intelligence."
  };
}
  ...
  return {
    ...
    method: {
      ...
      points: [
        ...
        "This ingest does not inspect your devices — optional local inventory only biases scoring in the browser when you add it.",
