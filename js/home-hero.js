/**
 * Homepage seasonal hero — trivial to replace via seasons/manifest.json.
 */
(function (global) {
  "use strict";

  var MANIFEST = "assets/images/home/seasons/manifest.json";
  ...
  function apply(root, entry, seasonId) {
    ...
    if (credit) {
      credit.textContent = entry.credit
        ? (entry.placeholder ? "Placeholder imagery · " : "") + entry.credit
        : "";
