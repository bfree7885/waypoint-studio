...
**Engine:** v0.1 architecture (no shipped UI or APIs)  
**Package:** `design-system/signal-intelligence/`

Consumers should share the observation contract — they must not invent parallel “alert” schemas that drop confidence, unknowns, or calm guidance.
...
|---------|--------------|------------|--------|
| **SignalTerrain** | Primary application home | Receivers, incident timelines, calm digests mapped to observations | Fake live spectrum or threat heatmaps |
...
Registry: `sharedEngines.signal-intelligence` (architecture v0.1).

---

## Shared contracts

1. Emit/consume `schema-v0.1` observations.  
2. Always keep **What / Why / Attention / Changed / Confidence** answerable.  
3. `insufficient` or rumor-quality evidence → Unavailable or speculative label — do not promote.  
...
- [ ] No placeholder cybersecurity dashboards  
