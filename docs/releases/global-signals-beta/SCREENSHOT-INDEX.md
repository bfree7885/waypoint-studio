...
Captured from `release/global-signals-beta` via local static server + headless Chrome
(`automation/capture-gs-beta-owner-review-screenshots.mjs`).

Owner review: [`../global-signals-beta-owner-review.md`](../global-signals-beta-owner-review.md)
...
| `13-explain-taiwan-desktop.png` | `/explain/?q=Why does Taiwan matter?` | desktop |
