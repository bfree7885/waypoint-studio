...
5. **Field maps should bridge tokens/fonts first**, not absorb the full studio topbar in one pass. Continuity + Inter/Cormorant removes the third type system without redesigning FABs.
