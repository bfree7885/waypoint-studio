...
> **Canonical source of truth for Waypoint Studio** (`bfree7885/waypoint-studio`).  
> Adapted from RC3 Sprint 0 for the consolidation onto this production platform.  
> Product implementations live under `/apps/*`; this document defines mission, hierarchy, and honesty rules.
