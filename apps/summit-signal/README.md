...
**V0.3** adds user-selected Start hike here routing (Valhalla pedestrian) and USGS 3DEP elevation profiles. It still does not pick a “best” trailhead or draw an activation-zone polygon.

Canonical documentation: [`docs/signal-terrain/V0.1.md`](../../docs/signal-terrain/V0.1.md) · [`docs/signal-terrain/V0.2.md`](../../docs/signal-terrain/V0.2.md) · [`docs/signal-terrain/V0.3.md`](../../docs/signal-terrain/V0.3.md)
