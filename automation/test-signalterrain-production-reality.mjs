...
ok(!/"href":\s*"apps\/signalterrain\/topics\.html"/.test(nav), "nav does not promote topic samples in product features");
ok(/side-trails\/signalterrain\/dashboard\//.test(nav), "nav includes real dashboard");
...
ok(/OPEN SIGNALTERRAIN/.test(landing), "ST landing OPEN SIGNALTERRAIN");
ok(/dashboard\//.test(landing), "ST landing links real dashboard");
ok(!/mockups\/dashboard\.html/.test(landing), "ST landing does not link mockups");
