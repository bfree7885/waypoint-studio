...
assert("access layer toggles in HTML", /data-layer="trails"/.test(html) && /data-layer="parking"/.test(html));
assert("access modules in HTML", /ss-access-model\.js/.test(html) && /ss-access-provider\.js/.test(html));
assert("OSM attribution in HTML", /OpenStreetMap/.test(html));
