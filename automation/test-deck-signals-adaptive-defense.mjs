...
} from "../scripts/deck-signals/lib/adaptive-defense.mjs";
import { recommendAction, enrichRecord } from "../scripts/deck-signals/lib/signal-engine.mjs";
...
ok(existsSync(join(root, "scripts/deck-signals/lib/adaptive-defense.mjs")), "adaptive defense lib");

const wf = join(root, ".github/workflows/deck-signals-refresh.yml");
ok(existsSync(wf), "GH Actions deck-signals refresh workflow");
