...
assert("home Shed Hunting entry", /shed-hunting/.test(home));
...
assert("studio-home lists public destinations", /dashboard/.test(studioHome) && /shed-hunting/.test(studioHome) && !/apps\/scenes\//.test(studioHome));
